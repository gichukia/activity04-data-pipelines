...
2.  There is a code chunk option of `message =`…
...
**Response**: When the ‘message’ option is turned to TRUE, we get to see
the information about the library we are loading, unlike when the option
is FALSE.
...
**Response**:When the message option is turned to ‘TRUE’, the column
specification is visible in the popup window. When the option is turned
off, the column specification does not appeare in the popup window.
...
**Response**:We need the major, major and the unemployment rate
variables to answer this question. For the first question, I would
arrange the data set by unemployment rate to obtain the major
corresponding to the lowest rate.
...
while Mathematics and Computer Science has the least unemployment rate.
...
**Response**: Food Science has the highest proportion of women while
Military Technologies has the least.
...
```
    ...
    ##  2 Communications                        27000  35000 45000
    ##  3 Criminal Justice And Fire Protection  26000  35000 45000
    ##  4 Commercial Art And Graphic Design     25000  35000 45000
    ##  5 Journalism                            26000  35000 42900
    ##  6 Multi-Disciplinary Or General Science 24000  35000 50000
    ##  7 Advertising And Public Relations      27000  35000 47000
    ##  8 Area Ethnic And Civilization Studies  24500  35000 44000
    ##  9 Special Needs Education               32000  35000 42000
    ## 10 Physiology                            20000  35000 50000
    ## # … with 71 more rows

Discuss your output as it relates to the research question.

**Response**: 81 majors have a median salary less than $36,000. Library
Science has the least median salary of all.
